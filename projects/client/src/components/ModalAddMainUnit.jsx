...
const ModalAddMainUnit = ({ setModalAddMainUnitOn, unit_type }) => {
        ...
        axios.post(API_URL + `/api/product/addunit?unit_type=${unit_type}`, {
            ...
            .then((res) => {
                if (res.data.message) {
                    ...
                    toast.success('Add main unit berhasil', {
                    ...
                    toast.error('Add main unit gagal, unit sudah tersedia', {
                        position: "bottom-center",
                        autoClose: 2000,
                        hideProgressBar: true,
                        closeOnClick: true,
...
export default ModalAddMainUnit;