        ...
        <div className='absolute -z-30 overflow-hide-print'>
            <div ref={componentRef}>
                <div style={{ width: 1000, height: 350 }}>
                    ...
                    <div className='ml-5 mt-3 border border-teal-500 rounded-lg bg-white mr-10 mb-[600px]'>
                        <div className='mr-5'>
                            <p className="text-3xl font-bold mt-5 mb-3 pl-5 text-main-500">TOTAL REVENUE</p>
                            <Line data={data.data[0]} options={options1} />
                        </div>
                    ...
                    <div className='ml-5 border border-teal-500 rounded-lg bg-white mr-10 mt-10 mb-32'>
                        <div className='mr-5'>
                            ...
                            <Line data={data.data[1]} options={options2} />
                        </div>
                    </div>
                    <div className='ml-5 mt-10 border border-teal-500 rounded-lg bg-white mr-10 mb-40'>
                        <div className='mr-5'>
                            ...
                            <Line data={data.data[2]} options={options2} />
                        </div>
                    </div>
                    ...
                    <div className='ml-5 mt-3 border border-teal-500 rounded-lg bg-white mr-10' >
                        <div className='mr-5'>
                            ...
                            <Line data={data.data[3]} options={options2} />
                        </div>
                        <div className='border shadow-lg h-52 bg-gray-100 rounded-lg my-10'>
