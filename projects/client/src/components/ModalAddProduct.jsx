            ...
            <div className="flex h-screen justify-center items-center">
                <div className="flex-col justify-center bg-white py-5 px-24 rounded-xl" style={{ height: '650px' }}>
                    ...
                    <div className="py-6" style={{ height: "540px" }}>
                        <h3 className="mb-7 text-xl font-medium text-gray-900">Add New Product</h3>
                            ...
                            <div>
                                ...
                                <div>
                                    ...
                                    <div className="flex">
                                        ...
                                        <input type="number" onChange={(e) => setPrice(e.target.value)} name="description" id="description" className="rounded-none rounded-r-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-full text-sm p-2.5" placeholder="Masukkan harga" required />
                                    </div>
                                </div>
                                <div>
                                    <label htmlFor="description" className="block mt-4 mb-2 text-sm font-medium text-gray-900">
