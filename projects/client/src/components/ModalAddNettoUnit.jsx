            ...
            <div className="flex h-screen justify-center items-center">
                <div className="flex-col justify-center bg-white py-5 px-12 rounded-xl w-96" style={{ height: '200px' }}>
                    ...
                    <div className="pt-6">
                        ...
                        <input id="search" type="form" onChange={(e) => setNewNettoUnit(e.target.value)} placeholder="Input nama baru untuk netto unit" className="border rounded-lg py-2 px-2 text-sm w-full" />
