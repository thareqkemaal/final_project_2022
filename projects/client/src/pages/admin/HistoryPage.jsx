    ...
    const printHistory = () => {
        return history.map((val, idx) => {
            return <tr className='border border-black divide-black divide-x'>
                <th scope="col" className="sm:py-3 sm:px-3 text-sm sm:text-lg text-center">
                    {val.date_change}
                </th>
                <th scope="col" className="sm:py-3 sm:pl-6 text-sm sm:text-lg text-center">
                    {val.product_name}
                </th>
                <th scope="col" className="sm:py-3 sm:px-3 w-32 text-sm sm:text-lg text-center">
                    {val.username}
                </th>
                <th scope="col" className="sm:py-3 sm:px-3 text-sm sm:text-lg text-center">
                    {val.unit}
                </th>
                <th scope="col" className="sm:py-3 sm:px-3 text-sm sm:text-lg w-20 text-center">
                    {val.quantity}
                </th>
                <th scope="col" className="sm:py-3 sm:px-3 text-sm sm:text-lg text-center">
                    {val.type}
                ...
                <div className='w-screen' style={{ background: "linear-gradient(155.7deg, #D6F5F3 -46%, #F7FCFC 100%, #F1F5FC 118%)" }}>
                    <div className='ml-5'>
                        ...
                        <div className='sm:flex relative mt-5 sm:mt-10'>
                            ...
                            <button type='button' className='transition mr-4 mt-4 sm:mt-0 bg-white border border-main-500 focus:ring-main-500 rounded-lg py-1 px-2 hover:-translate-y-1 hover:bg-main-500 w-20 sm:w-30 text-black' onClick={() => {
                                handleFilter()
                            }}>Filter</button>
                            <button type='button' className='transition mr-4 mt-4 sm:mt-0 bg-white border border-main-500 focus:ring-main-500 rounded-lg py-1 px-2 hover:-translate-y-1 hover:bg-main-500 w-20 sm:w-30  text-black' onClick={() => {
                        ...
                        <div className={`${history.length == 0 ? 'hidden' : "flex flex-col items-end mr-2 sm:mr-12"}`}>
                            {/* <!-- Help text --> */}
                            <span className="sm:text-lg text-sm text-gray-700 dark:text-gray-400">
