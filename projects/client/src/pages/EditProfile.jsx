        ...
        >
            ...
            >
                <div className='lg:mx-80'>
                    <label className='block mb-3'>
                        <spam className='block text-sm font-medium text-slate-700 mb-1'>Address</spam>
                        <input className='border border-gray-400 w-full rounded-md px-2'/>
                    </label>
                    <div className='grid grid-cols-2 gap-4'>
                        <label className='block mb-3 '>
                            <spam className='block text-sm font-medium text-slate-700 mb-1'>City</spam>
                            <input className='border border-gray-400 w-full rounded-md px-2'/>
                        </label>                        
                        <label className='block mb-3'>
                            <spam className='block text-sm font-medium text-slate-700 mb-1'>State</spam>
                            <input className='border border-gray-400 w-full rounded-md px-2'/>
                        </label>                        
                    </div>
                    <div className='grid grid-cols-2 gap-4'>
                        <label className='block mb-3 '>
                            <spam className='block text-sm font-medium text-slate-700 mb-1'>Zip Code</spam>
                            <input className='border border-gray-400 w-full rounded-md px-2'/>
                        </label>                        
                        <label className='block mb-3'>
                            <spam className='block text-sm font-medium text-slate-700 mb-1'>Country</spam>
                            <input className='border border-gray-400 w-full rounded-md px-2'/>
                        </label>                        
                    </div>
                    <button className=' mt-5 border bg-teal-500 hover:bg-teal-700 rounded-md py-2 text-white px-10'>Save</button>
